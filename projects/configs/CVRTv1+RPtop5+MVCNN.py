...
save_dir = '/home/sapark/CVRT_GVCNN/result/CVRTv1+RPtop5+MVCNN'
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1,
                            attention=dict(type='MultiheadSVAttention', num_views=num_views, num_query=num_query, num_key=num_rpn_per_view, scale_dot_type='MVCNN', attn_filtering=5)),
                        dict(type='TMVReidMultiheadCrossAttention', embed_dims=256, num_heads=8, dropout=0.1,
...
save_reid_pickle = dict(eval_thresh=.1, reid_thresh=.1, visible_thresh=.5, out_dir='/home/sapark/frcnn_keras_original/pickle/messytable/CVRTv1+RPtop5+MVCNN/reid_output/test')
