...
save_dir = '/home/sapark/exp59_ddet/result/CVRTv1+RPtop1+QueryAttnFusion'
...
save_reid_pickle = dict(eval_thresh=.1, reid_thresh=.1, visible_thresh=.5, out_dir='/home/sapark/frcnn_keras_original/pickle/messytable/CVRTv1+RPtop1+QueryAttnFusion/reid_output/test')
